"""
SMAP-FYP Central Configuration — PostgreSQL-Only Architecture
Reads settings from .env and provides PostgreSQL connection utilities.
"""
import os
...
def get_db():
    """
    Return (connection, cursor) or raise RuntimeError if PostgreSQL unavailable.
    ...
    try:
        ...
        # We use RealDictCursor to match the 'dictionary=True' behavior of PostgreSQL-connector
        ...
        raise RuntimeError(
            ...
            f"Error: {e}\n"
            f"Make sure DATABASE_URL in .env is correct."
        )
