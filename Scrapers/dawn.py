"""
Dawn.com News Scraper → PostgreSQL `articles` table
...
def run():
    print(f"[dawn] Crawling Dawn.com → PostgreSQL `articles`")
    ...
    print(f"[dawn] Done. {saved}/{len(urls)} articles saved to PostgreSQL.")
