"""
Daily Technical Indicators → PostgreSQL `indicators` table
Reads historical_prices from PostgreSQL, calculates MACD + daily indicators,
...
def load_stock(symbol):
    ...
    if not rows:
        print(f"[daily_indicators] No data for {symbol} in PostgreSQL.")
    return rows
...
def main():
    ...
    print("\n[daily_indicators] All stocks → PostgreSQL `indicators`")
